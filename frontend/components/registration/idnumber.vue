...
<template>
  <v-container>
    ...
    <v-row class="mt-2">
      <div>Provide your ID number of the Royal Belgian Chess Federation</div>
    </v-row>
    <v-row>
      <v-col cols="12" md="6">
        <v-text-field v-model="idbel" label="Belgian ID number" :disabled="isFidePlayerFound"
          required />
      </v-col>
      <v-col cols="12" md="6">
    ...
    <v-row class="mt-2">
      <div>Provide your FIDE ID number</div>
    </v-row>
    <v-row>
      <v-col cols="12" md="6">
        <v-text-field v-model="idfide" :disabled="isBelPlayerFound" label="FIDE id."
          required />
      </v-col>
      <v-col cols="12" md="6">
