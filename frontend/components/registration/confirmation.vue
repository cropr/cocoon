...
<template>
  <v-container>
    ...
    <v-row v-show="isConfirmed" class="my-4">
      <b>Do not pay yet.</b>  We first want to validate your registration, which can take a few days.   
      Once validated, we will send you in a separate email the detailed payment instructions. 
    </v-row>
    <hr />
